...
esp_err_t create_task(void)
{
    ...
    xTaskCreate(vTask_R,          // funcion que vamos a pasarle para que se ejecute en la tarea (vTask_R)
    ...
    xTaskCreate(vTask_G,          // funcion que vamos a pasarle para que se ejecute en la tarea (vTask_R)
    ...
    xTaskCreate(vTask_B,          // funcion que vamos a pasarle para que se ejecute en la tarea (vTask_R)
